...
def set_metadata():
    ...
    metadata_xml_args   = { 'DSI_OS' : DSI_OS, 'DSI_TEMPLATE' : DSI_TEMPLATE, 'DSI_FLAG_SID' : '1', 'DSI_STATUS' : 'INITIAL' , 'DSI_IMAGE_TYPE': 'SELFMANAGED' , 'DSI_FLAG_ADMINLAN': '1', 'DSI_FLAG_PWM': '1'}
   # metadata_xml_args   = { 'DSI_OS' : DSI_OS, 'DSI_FLAG_SID' : '1', 'DSI_STATUS' : 'INITIAL' , 'DSI_IMAGE_TYPE': 'SELFMANAGED' , 'DSI_FLAG_ADMINLAN': '1', 'DSI_FLAG_PWM': '0'}
